...
It plots the features, correlation plots of the features, and calculates Fisher scores. It also compares multiple machine learning classifiers using caretEnsemble.
...
Additionally the classifier models which were generated are included in the repository as .rds files. Rerunning the classifier training does not produce identical classifiers 
(likely due to some randomization which isn't controled by setting the seed for the random number generator), although the accuracy was similar when I tried it. 
The original classifier can be loaded and used to generate the dotplot at the end of the notebook.
